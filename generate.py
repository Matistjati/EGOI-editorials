...
years = {
    ...
    ,
    "2024":
        ["Infinite Race", "Bouquet", "Team Coding", "Garden Decorations", "Circle Passing", "Bikeparking", "", "Make them Meet"]
    ,
    "2023":
        ["Inflation", "Padel Prize Pursuit", "Find the Box", "Bikes vs Cars", "Carnival General", "Candy", "Sopsug", "Guessing Game"]
    ,
    "2022": 
        ["", "", "Social Engineering", "", "Data Centers", "", "Toy Design", ("Chika Wants to Cheat", "cheat.pdf")]
    ,
    "2021":
        ["Shopping Fever", "Trains", "Angry Cows", "Double Move", "Zeros", "Luna", "Cookies", "Lanterns"]
}

header = ["Year", "D1-1", "D1-2", "D1-3", "D1-4", "D2-1", "D2-2", "D2-3", "D2-4"]
